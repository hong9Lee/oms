...
- 선택지: **root** / **oms-core** / **oms-plan**

### Step 3. 서비스 컨텍스트 로드
- **root 선택 시**: 이 단계를 스킵하고 Step 4로 진행한다.
- **oms-core / oms-plan 선택 시**: 선택된 서비스의 다음 파일들을 **즉시 읽는다** (Read 도구 사용):
...
**root 선택 시:**
```
Backend 모드 (root) 로 전환되었습니다.

다음 작업을 도와드릴 수 있습니다:
- CLAUDE.md, 규칙, 에이전트 설정 수정
- 공통 도메인 용어/컨텍스트 관리
- 프로젝트 구조 및 설정 작업
